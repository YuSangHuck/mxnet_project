...
def Train_create(dataset_dir, framework, out_model_dir, max_epochs, mb_size, network_name):
    if framework == 4:
        ...
        num_examples  = read_num(Dataset.Dataset_result(out_dataset_dir)[2])#read dataset.lst
        data_train = Dataset.Dataset_result(dataset_dir)[3]#dataset.rec       
        ...
        parser.set_defaults(
            ...
            disp_batches   = int(num_examples/mb_size/5),
            )
...
if __name__ == '__main__':
    Train_create(dataset_dir=out_dataset_dir, framework=4, out_model_dir=out_model_dir, max_epochs=20, mb_size=128, network_name='lenet')
